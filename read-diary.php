...
<head>
    ...
    <title>Hayat cok zor gunluk</title>
...
<body>
    ...
    <div class="main">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="http://localhost/gunluk/">Acil Cikis</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="container">
            <a class="back-button" href="http://localhost/gunluk/home.php">< Back</a>
            <div class="read-diary-container">
                <h1>Tuttugunuz gunlukler.</h1>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal">Hepsini Goruntule</a>
                            </div>
                        </div>
